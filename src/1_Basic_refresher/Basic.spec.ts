...
//3) [ ] Write a test to create an instance of a car class that takes an argument of brand and price, with properties brand of type string and price of type number
...
//9) [ ] Write a test to see if the class has a static function called Parking that creates an array called 'parking' can holds instances of cars - test by verifying the array length after adding a car.
...
//13b) Install axios
//13c) import axios, mock it with vi.spyOn(axios, 'get').mockResolvedValue(expectedResult), write the mock response, then write the test.
